...
### Вызов стороннего скрипта из программы
...
**Виртуальное окружение** — это изолированная папка внутри вашего проекта. В ней лежит отдельная копия интерпретатора Python и свои собственные библиотеки.
...
2. Далее вход в окружение:

```Nginx
venv\Scripts\activate
```

(Если вы используете PowerShell в VScode и видите ошибку, попробуйте команду: `Set-ExecutionPolicy RemoteSigned -Scope CurrentUser`, а затем снова активацию).

3. Посмотрите на строку ввода в терминале. В начале строки (обычно в скобках) должно появиться название вашего окружения:

Было:  
C:\Users\Name\MyProject>

Стало:  
(venv) C:\Users\Name\MyProject>

Если вы планируете выкладывать код на GitHub: папку venv **никогда** не выкладывают в репозиторий. Она весит много и содержит файлы, специфичные для вашего компьютера.  
Чтобы Git игнорировал эту папку, создают файл .gitignore и пишут туда одну строчку: venv/.